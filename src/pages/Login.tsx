            ...
            <div className="card-login shadow-lg" style={{maxWidth: '450px', width: '100%', borderRadius: '1rem'}}>
                ...
                <div className="d-grid gap-3">
                    ...
                    >
                        ...
                        <svg className="me-2" width="20" height="20" viewBox="0 0 48 48" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M44.5 20H24V28.5H35.42C34.78 31.42 32.74 33.72 30.12 35.38V40.75H38.5C43.34 36.36 46 29.58 46 20H44.5Z"
                                fill="#4285F4"/>
                            <path
                                d="M24 46C30.34 46 35.74 43.96 39.81 40.75L30.12 35.38C27.91 36.87 25.13 37.75 24 37.75C19.74 37.75 16.03 34.98 14.77 31.06L4.5 31.06V36.31C6.9 41.22 14.15 46 24 46Z"
                                fill="#34A853"/>
                            <path
                                d="M14.77 31.06C14.17 29.35 13.84 27.64 13.84 24C13.84 20.36 14.17 18.65 14.77 16.94L14.77 11.69L4.5 11.69C2.06 16.63 2.06 29.37 4.5 34.31L14.77 31.06Z"
                                fill="#FBBC05"/>
                            <path
                                d="M24 10.25C26.54 10.25 28.84 11.11 30.72 12.87L38.79 4.75C35.74 1.76 30.34 0 24 0C14.15 0 6.9 4.78 4.5 9.78L14.77 16.94C16.03 13.02 19.74 10.25 24 10.25Z"
                                fill="#EA4335"/>
                        </svg>
